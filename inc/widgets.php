...
class Masonry_Brick_Tabbed_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                ...
                array('description' => esc_html__('Displays the popular posts, recent posts and the recent comments in the tabs.', 'masonry-brick')) // Arguments of the widget, here it is provided with the description
        );
    }
    ...
    function widget($args, $instance) {
        ...
        <div class="tab-content masonry-brick-tab-content">
            ...
            <ul class="masonry-brick-tabs" role="tablist">
                <li role="presentation" class="popular active"><a href="#popular"><i class="fa fa-star"></i><?php esc_html_e('Popular', 'masonry-brick'); ?></a></li>
                <li role="presentation" class="recent"><a href="#recent"><i class="fa fa-history"></i><?php esc_html_e('Recent', 'masonry-brick'); ?></a></li>
                <li role="presentation" class="comment"><a href="#user-comments"><i class="fa fa-comment"></i><?php esc_html_e('Comment', 'masonry-brick'); ?></a></li>
            </ul>
