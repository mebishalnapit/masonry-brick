 ...
 */
if (!function_exists('masonry_brick_meta_box_display_toggle')) :

    function masonry_brick_meta_box_display_toggle() {
        $custom_script = '
...
add_action('admin_footer', 'masonry_brick_meta_box_display_toggle');
